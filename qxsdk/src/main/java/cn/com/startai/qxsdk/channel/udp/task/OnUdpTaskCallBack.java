...
public interface OnUdpTaskCallBack {
     ...
     * @param mWiFiDevice
     */
    void onDeviceDiscoveryResult(String id, boolean result, DeviceBean mWiFiDevice);
     ...
     */
    void onLanBindResult(boolean result, DeviceBean mLanBindingDevice);
     ...
     * @param mLanBindingDevice
     */
    void onLanUnBindResult(boolean result, DeviceBean mLanBindingDevice);
