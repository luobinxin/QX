...
//                    QXLog.d(LogTag, "时延偏高，开始减权值，当前节点" + host + "权值 = " + weight);
//
//                    double v = delay * 1.0 / 1000;
//                    double delayDou = (double) Math.round(v * 100) / 100;
//                    QXLog.d(LogTag, "delayDou = " + delayDou);
//                    double v1 = 0.2 * delayDou;
//                    weight -= v1;
//                    weight = (double) Math.round(weight * 100) / 100;
//                    nodeBean.setWeight(weight);
//
//                    QXLog.d(LogTag, "权值下降 " + v1 + " ,下降后的权值为 " + weight);
//
//
//                    if (weight <= 0) {
//                        QXLog.d(LogTag, "当前节点" + host + "权值已经小于0，将自动更换节点");
//                        //需要更换节点
...
//        } else {
//
//            QXLog.d(LogTag, "本地没有节点权值信息，需要去云端请求");
