...
import cn.com.startai.qxsdk.connect.udp.task.system.ControlReceiveTask;
import cn.com.startai.qxsdk.connect.udp.task.system.DeviceBindTask;
import cn.com.startai.qxsdk.connect.udp.task.system.DeviceDiscoveryTask;
import cn.com.startai.qxsdk.connect.udp.task.system.HeartbeatReceiveTask;
import cn.com.startai.qxsdk.connect.udp.task.system.RequestTokenReceiveTask;
import cn.com.startai.qxsdk.connect.udp.task.system.SleepReceiveTask;
...
public class ProtocolTaskImpl extends SimpleProtocolResult {
    ...
    private final OnUdpTaskCallBack mTaskCallBack;
