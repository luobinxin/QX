...
public class QXErrorCode {
    ...
    public static final String ERROR_SEND_UNKOWN = "5003"; //发送失败，未知异常
    public static final String ERROR_SEND_NET = "5004";
    public static final String ERROR_SEND_NO_LOGIN = "5006";
    public static final String ERROR_SEND_NO_ACTIVITE = "5007";
    ...
    public static final String ERROR_LOST_CLIENT = "6002";
    public static final String ERROR_LOST_TIMEOUT = "6003";
    public static final String ERROR_LOST_HEART_TIMEOUT = "6004";
    public static final String ERROR_LOST_SELF_DISCONNECT = "6005";//用户主动断开
    public static final String ERROR_LOST_NET_UNVALAIBLE = "6006";//断开，网络不可用
    public static final String ERROR_LOST_CHANGE_HOST = "6007";//断开，切换网络
